...
export const hookNSASTParse = (baseAddr: BaseAddr) => {
    ...
    // {
    //     const funcName = 'night::NSASTParse::ast_expression_no_comma(void)'
    //     const targetAddr = baseAddr.resolveAddress('0x0041402E')
    //     // ReadFile
    //     if (targetAddr != null) {
    //         const arg: Record<string, NativePointer> = {}
    //         Interceptor.attach(targetAddr, { // Intercept calls to our SetAesDecrypt function
                ...
                */
                onEnter: function (args) {
                    try {
                        ++i
                        this.index = i
                        if (this.index != 92 && this.index != 93) return 
                        console.log(`${funcName} - onEnter${this.index}`);
                        console.log('[+] Called targetAddr:' + targetAddr);
                        // console.log('[+] Ctx: ' + args[-1]);
                        // console.log('[+] FormatString: ' + Memory.readAnsiString(args[0])); // Plaintext
    ...
    // }
    // {
    //     const funcName = 'night::NSASTParse::ignore_punc(std::string const&)	.text	'
    //     const targetAddr = baseAddr.resolveAddress('0x00410EF0')
    //     // ReadFile
    //     if (targetAddr != null) {
    //         const arg: Record<string, NativePointer> = {}
    //         Interceptor.attach(targetAddr, { // Intercept calls to our SetAesDecrypt function
