...
export const hookNSCompileJs = (baseAddr: BaseAddr) => {
                ...
                */
                onEnter: function (args) {
                    try {
                        ++i
                        this.index = i
                        this.output = this.index >= 750 && this.index <= 805
    ...
    {
        const funcName = 'night::NSCompileJs::compile_obj_dot(night::ns_node *)'
        const targetAddr = baseAddr.resolveFunctionAddress(funcName)
        if (targetAddr != null) {
            let i = 0
            Interceptor.attach(targetAddr, { // Intercept calls to our SetAesDecrypt function
    ...
    {
        const funcName = 'night::NSCompileJs::compile_obj_property(night::ns_node *)'
        const targetAddr = baseAddr.resolveFunctionAddress(funcName)
        if (targetAddr != null) {
            let i = 0
            Interceptor.attach(targetAddr, { // Intercept calls to our SetAesDecrypt function
