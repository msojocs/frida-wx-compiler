...
export const hookCompiler = (baseAddr: BaseAddr) => {
    ...
    // {
    //     const funcName = 'WXML::Compiler::RenderDefine(zcc::shared_ptr<WXML::DOMLib::WXMLDom> &,std::string const&,std::map<std::string,std::string> &,std::string&,std::basic_stringstream<char,std::char_traits<char>,std::allocator<char>> &,std::map<std::string,std::string> const&,bool,uint,char,std::string const&,std::string const&,std::string const&,std::string const&,std::string const&,std::string const&,std::string const&,std::string const&,std::string const&,std::string const&,std::string const&)	.text	004050F6'
    //     const targetAddr = baseAddr.resolveAddress('0x004050F6')
    //     // ReadFile
    //     if (targetAddr != null) {
    //         let i = 0
