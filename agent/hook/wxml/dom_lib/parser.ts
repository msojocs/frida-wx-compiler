...
export const hookParser = (baseAddr: BaseAddr) => {
    ...
    {
        const funcName = 'WXML::DOMLib::Parser::Parse'
        const targetAddr = baseAddr.resolveAddress('0x422450')
        // ReadFile
        if (targetAddr != null) {
                ...
                */
                onEnter: function (args) {
                    try {
                        ...
                        console.log('[+] Argv1: ', new StdString(args[1]).toString()); // This pointer will store the de/encrypted data
