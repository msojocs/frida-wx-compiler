...
try {
    ...
    console.log('resolveAddress: start')
    var monitorFuncAddr = resolveAddress('0x171C'); // Here we use the function address as seen in our disassembler

    // monitorFuncAddr = ptr('0x008e2150')
    console.log('resolveAddress: end -> ', monitorFuncAddr)
    // printRef
    Interceptor.attach(resolveAddress('0x1F80'), { // Intercept calls to our SetAesDecrypt function
        ...
        */
        onEnter: function (args) {
            try {
                ...
                console.log('arg0:', StdString.readData(args[0]))
